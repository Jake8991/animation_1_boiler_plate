...
# import assets
sprite_sheet = pygame.image.load("Christmas_Tree_FINAL.png").convert_alpha() # add the path/name of your sprite sheet file

# get details about individual sprites
total_sprites = 7 # code the number of sprite images your sprite sheet has
